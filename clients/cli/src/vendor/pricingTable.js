// Vendored from server/src/pricing/table.js — kept in sync manually, same pattern
// as server/src/providers/llm-router/ (see the root README's "Project layout"
// section: "vendored... so the folder can be lifted into its own repo as-is").
// This CLI ships standalone (npx/global install), outside the monorepo checkout,
// so it cannot `require("../../../server/src/...")` at runtime.
//
