...
import { Card, Table, Stat, Toggle, Badge, Spinner, Tabs, useTabParam, ConfirmDialog, Drawer } from "../components/ui.jsx";
...
// per-task `evidence` (top-3 candidates) the regenerate endpoint returns. The first candidate is the
// chosen winner; the others are the runners-up it was ranked against.
function ReasoningDrawer({ evidence, catalog, goal, generatorModel, onClose }) {
  const labelOf = {};
